        ...
        <>
            <form onSubmit={handleSubmit(handleWorkerRegistration)}>
                <div className="container mx-auto w-full mt-5">
                    <div className="w-full grid sm:grid-cols-1 lg:grid-cols-2 gap-x-4 gap-y-3">
                        <div>
                            ...
                            {errors.username && (<p className="mx-3 mt-0.5 text-red-500 text-xs ">* {errors.username.message?.toString()}</p>)}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.email && (<p className="mx-3 mt-0.5 text-red-500 text-xs ">* {errors.email.message?.toString()}</p>)}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.phoneNumber && (<p className="mx-3 mt-0.5 text-red-500 text-xs ">* {errors.phoneNumber.message?.toString()} </p> )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.location && (<p className="mx-3 mt-0.5 text-red-500 text-xs ">* {errors.location.message?.toString()}</p>)}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.qualification && ( <p className="mx-3 mt-0.5 text-red-500 text-xs ">* {errors.qualification.message?.toString()}</p>)}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.experience && (<p className="mx-3 mt-0.5 text-red-500 text-xs ">* {errors.experience.message?.toString()}</p> )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.password && ( <p className="mx-3 mt-0.5 text-red-500 text-xs ">* {errors.password.message?.toString()}</p>)}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.confirmPassword && ( <p className="mx-3 mt-0.5 text-red-500 text-xs ">* {errors.confirmPassword.message?.toString()} </p>)}
                        </div>
                        <div>
                            <button id="registerBtn" className="gradient-btn md:w-[100%] w-full font-Montserrat">
                                Upload Documents
                            </button>
                        </div>
                    </div>
            ...
            <h6 className="my-3 font-Montserrat font-[400] text-[12px]">
                ...
                <Link to="/worker/login" className="font-[600] text-[14px] text-[#385185]" >
                    Sign in
                </Link>
            </h6>
        </>
