...
const WorkerLandingPageService = () => {
  return (
    <div className='w-[50%] mx-auto mt-10 bg-[#edebeb] p-4 rounded-2xl shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]'>
