            ...
            <div className='py-28 max-w-6xl mx-auto font-Montserrat'>
                <div className='flex py-3'>
                    <div className='w-6/12 flex justify-center items-end'>
                        <div className='w-[90%] h-[90%] rounded-lg drop-shadow-2xl' style={{ backgroundImage: "url('/image/about.jpg')", backgroundSize: 'cover' }}>
                        </div>
                    </div>
                ...
                <div className='flex pt-28'>
                    ...
                    <div className='w-6/12 flex justify-center items-end'>
                        <div className='w-[90%] h-[90%] rounded-lg drop-shadow-2xl' style={{ backgroundImage: "url('/image/about-work-tool.jpg')", backgroundSize: 'cover' }}>
                        </div>
                    </div>
