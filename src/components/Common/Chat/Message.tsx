    ...
    return (
        <div className='mt-4'>
            <div className={`${sender && 'flex-row-reverse'} flex items-end gap-x-2 cursor-pointer`}>
                ...
                <div className={`md:text-[1rem] text-[0.9rem] leading-5 md:max-w-[22rem] max-w-[75%]  px-4 py-2 mb-2  ${sender ? 'rounded-tr-2xl rounded-tl-lg rounded-bl-2xl bg-[#c5c4d8]' : 'bg-[#96939c9b] rounded-br-2xl rounded-tl-2xl rounded-tr-lg'}`}>
                    {msg.text} 
                </div>
            </div>
