        ...
        <div className="md:w-6/12  w-[100%] h-[100%] lg:my-16 my-10 px-4 lg:px-0 ">
          <div className="relative lg:w-[80%]">
            ...
            <div className="absolute -bottom-2 right-4 md:right-28 lg:right-3 -z-10">
              ...
              >
                <path
                  d="M53.5177 21.8398C77.351 12.3398 153.21 -5.89061 227.21 8.09507C281.109 18.2817 338.268 36.4501 339.739 70.7726C341.21 105.095 243.558 126.575 175.239 131.773C106.851 136.975 8.7684 129.95 3.23922 96.2726C-2.28996 62.5951 89.1863 21.8067 157.518 14.3397C188.015 11.0072 205.864 11.6893 236.018 17.3397"
                  stroke="#D3F985"
                  stroke-width={6}
          ...
          <div className="md:text-left text-center mt-8">
            ...
            <button
              className="flex items-center gap-2 md:px-6  py-2 font-sans md:text-xs text-blue-900 md:text-white font-bold  md:bg-black uppercase align-middle transition-all rounded-lg select-none disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none hover:bg-gray-900/10 active:bg-gray-900/20"
              type="button"
            >
              Explore More
              <svg
