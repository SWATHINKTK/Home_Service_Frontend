                    ...
                    <div className='md:w-8/12 px-4'>
                        <div className="grid gap-x-6 gap-y-4 md:grid-cols-2 ">
                            <div>
                                ...
                                <input
                                    type="text"
                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="build / house"
                                ...
                                {errors.buildingName && (
                                    <p className="mx-3 mt-0.5 text-red-500 text-xs">
                                        * {errors.buildingName.message?.toString()}
                                    </p>
                                )}
                            </div>
                            <div>
                        ...
                        <textarea
                            rows={4}
                            className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 " placeholder="Write your issue here..."
