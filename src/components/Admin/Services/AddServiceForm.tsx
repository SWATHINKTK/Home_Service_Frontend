...
const AddServiceForm: React.FC = () => {
    ...
    const { register, handleSubmit, formState: { errors } } = useForm<IService>();
            ...
            <div className='relative overflow-scroll hide-scrollbar sm:rounded-lg'>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="w-[90%] mx-7">
                        ...
                        {errors.serviceName && (<p className="mx-2 mt-0.5 text-red-500 text-xs ">* {errors.serviceName.message?.toString()}</p>)}
                        ...
                        <div className="md:flex  gap-4 mt-2">
                            <div className="w-full">
                                ...
                                {errors.minimumAmount && (<p className="mx-3 mt-0.5 text-red-500 text-xs ">* {errors.minimumAmount.message?.toString()}</p>)}
                            </div>
                            ...
                            <div className="w-full">
                                ...
                                {errors.hourlyAmount && (<p className="mx-3 mt-0.5 text-red-500 text-xs ">* {errors.hourlyAmount.message?.toString()}</p>)}
                            </div>
                        </div>
                        ...
                        <div className="mt-4 flex gap-5">
                            ...
                            >
                                ...
                                <input type="file" accept="image/*" style={{ display: "none" }}
                                    ref={(el) => { if (el) fileInputRefs.current[1] = el; }}
