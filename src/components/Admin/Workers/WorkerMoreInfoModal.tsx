            ...
            <div>
                ...
                <div className="mt-7">
                    ...
                    <div className="mt-0.5">
                        ...
                        <div>
                            <img className="h-[16rem] w-auto" src={typeof data.certificate === "string" ? data.certificate : ""} alt="Certificate Image"/>
                        </div>
                    </div>
                    <div className="mt-9">
                        <span className="font-bold">ID Proof</span>
                        <div>
                            <img className="h-[16rem] w-auto" src={typeof data.idProof === "string" ? data.idProof : ""} alt="ID Proof Image" />
                        </div>
                    </div>
                </div>
            </div>
